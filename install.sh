...
function install_prepare_software_on_ubuntu()
{
    ...
    sudo apt-get install -y clang-format exuberant-ctags build-essential python python-dev python3-dev fontconfig libfile-next-perl ack-grep git
...
{
    sudo apt-get update
    sudo apt-get install -y cmake ctags cscope silversearcher-ag exuberant-ctags build-essential python python-dev python3-dev fontconfig libfile-next-perl ack-grep git
    compile_vim_on_ubuntu
}
